...
impl SDSP {
    ...
    /// 128バイトメモリから初期化
    pub fn initialize(&mut self, ram: &mut [u8], dsp_register: &[u8; 128]) {
    ...
    /// DSPレジスタの書き込み処理
    pub fn write_register(&mut self, ram: &[u8], address: u8, value: u8) {
    ...
    /// DSPレジスタの読み込み処理
    pub fn read_register(&self, _ram: &[u8], address: u8) -> u8 {
